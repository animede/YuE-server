...
from common import BlockTokenRangeProcessor, parser, get_cache_class
...
def stage2(args):
    ...
    print("***args.stage2_use_exl2=",args.stage2_use_exl2)
    if args.stage2_use_exl2==True:
